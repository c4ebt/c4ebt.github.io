...
#### About Hackasat
Hackasat2020 Quals was a ctf realized on the weekend of May 23rd. I wasn't planning on doing it but then a buddy from the CTF team Cntr0llz invited me to participate with them (thanks :D!).
...
The biggest reason I struggled in this challenge was because most of the concepts I needed to apply were completely unknown to me (I had no idea what PWN signals or azimuth or a duty cycle was), so I had to research a lot about them in order to understand them.
...
The azimuth elevation normally is an angle between 0 and 180, 0 - 90 meaning it is below the horizon and 90 - 180 meaning it is above the horizon. In the picture above we can see the elevation angle is of about 45° above the horizon, or 135° (90 + 45).
